      ...
      <div>
        ...
        <div className="bio">
          ...
          <div className="bio-body">
            <p className="bio-body-p">  Nice to meet you. My name is Alec, and creating things is my passion. Whether it be music, art, web applications, furniture, electronics, or film, I'm here to create and help others create.</p>
            <br />
            <p className="bio-body-p">What you'll find here is a repository of my work, across many mediums. I've chosen to present it all in one place to paint a picture of the complete person, rather than just the developer, producer, or any other single label. I learned to code through making music, and I learned to produce through code. The line between mediums is blurry at best.</p>
            <br />
            <p className="bio-body-p">If you are curious about my work, would like to collaborate, or want to say hello, you can reach me by email at.</p>
          </div>
